    ...
    <div className="relative">
      ...
      >
        {profile?.avatar ? (
          ...
          <span className="grid place-items-center w-full h-full bg-white/10">
  ...
  return (
    <div className={cn("min-h-screen grid place-items-center px-6 text-center")}>
      <div className="max-w-sm">
        <div className="font-black text-4xl tracking-widest bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-400 via-purple-300 to-cyan-400 mb-3">
          TRANCE
        </div>
