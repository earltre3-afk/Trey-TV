...
export const rowToIdentity = (row: Record<string, unknown>): TranceIdentity => {
  const treyTvRoles = Array.isArray(row.trey_tv_roles) 
    ...
    : (Array.isArray(row.roles) && row.roles.includes('admin') ? ['admin' as TranceRole] : []);
  
  const tranceRoles = Array.isArray(row.trance_roles)
    ? (row.trance_roles as TranceRole[])
    : (Array.isArray(row.roles) ? (row.roles as TranceRole[]) : ['dancer' as TranceRole]);
 ...
 */
export const mapTreyTvProfileToTranceProfile = (treyProfile: Record<string, unknown> | null | undefined): DancerProfile => {
  if (!treyProfile) {
...
async function ensureProfile(userId: string, meta?: { handle?: string; display_name?: string }): Promise<DancerProfile> {
  try {
...
export const tranceAuthBridge = {
  ...
  demoProfile: {
    ...
    avatar: 'https://d64gsuwffb70l.cloudfront.net/6a1ddb096616cb7e4e894f24_1780341613307_1a2c4519.jpg',
    verified: true,
    ...
    cover: 'https://d64gsuwffb70l.cloudfront.net/6a1ddb096616cb7e4e894f24_1780341613307_1a2c4519.jpg',
    memberNumber: 1,
  },
  ...
  demoIdentity: {
    ...
    displayName: 'Trey Trizzy',
    handle: '@treytrizzy',
    avatarUrl: 'https://d64gsuwffb70l.cloudfront.net/6a1ddb096616cb7e4e894f24_1780341613307_1a2c4519.jpg',
    bannerUrl: 'https://d64gsuwffb70l.cloudfront.net/6a1ddb096616cb7e4e894f24_1780341613307_1a2c4519.jpg',
