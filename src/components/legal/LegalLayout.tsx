...
export function LegalLayout({ policy, children }: { policy: LegalPolicy; children?: ReactNode }) {
  return (
    <AppShell wide>
      <div className="relative pb-10">
        ...
        <div className="relative overflow-hidden rounded-[28px] liquid-glass neon-border p-6 lg:p-10 mb-6">
          ...
          <div className="relative">
            <Link
              to="/legal"
              className="inline-flex items-center gap-1.5 text-[11px] tracking-[0.22em] text-muted-foreground hover:text-foreground transition"
            >
        ...
        <div className="grid lg:grid-cols-[260px_minmax(0,1fr)] gap-6">
          ...
          <div className="space-y-3 lg:space-y-4">
            ...
            <div className="flex flex-wrap gap-2 pt-4">
              <Link
                to="/legal"
                className="inline-flex items-center gap-1.5 px-4 h-10 rounded-xl liquid-glass border border-white/10 text-sm font-semibold hover:border-white/30 transition"
              >
                <ArrowLeft className="size-4" /> Back to Legal Hub
              </Link>
              <Link
                to="/legal/data-deletion"
                className="inline-flex items-center gap-1.5 px-4 h-10 rounded-xl bg-primary text-primary-foreground text-sm font-bold glow-gold tilt-press"
              >
                Data Request
              </Link>
            </div>
