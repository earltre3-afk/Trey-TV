...
export function LegalHubCard({
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-br from-[oklch(0.82_0.15_215/0.08)] via-transparent to-[oklch(0.82_0.16_85/0.06)] pointer-events-none"
      />
