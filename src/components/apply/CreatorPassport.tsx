  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div
          className={`mx-auto mt-4 h-44 w-full max-w-[220px] overflow-hidden rounded-2xl bg-[radial-gradient(ellipse_at_50%_30%,oklch(0.2_0.08_260),oklch(0.08_0.02_260))] ${accentRing}`}
        >
          {avatarUrl ? (
            <img
              src={avatarUrl}
        ...
        <div className="mt-5 flex justify-center">
          <CircularProgress
            ...
            variant={variant}
            label={`${progress}%`}
            sublabel={`Step ${step} of ${totalSteps}`}
          />
        </div>
      </div>
    </div>
