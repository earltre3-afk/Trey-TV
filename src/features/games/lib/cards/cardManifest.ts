...
export const SUIT_DISPLAY: Record<
  Suit,
  { name: string; symbol: string; color: string; glow: string; gameplay: string }
> = {
  spades: {
    name: "Blades",
    symbol: "♠",
...
const SUIT_FOLDER: Record<Suit, string> = {
  spades: "blades",
  hearts: "soul",
  diamonds: "flame",
  clubs: "keys",
...
export const CARD_MANIFEST: CardDef[] = (
