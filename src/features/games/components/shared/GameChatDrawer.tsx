        ...
        >
          ...
          <div className="px-4 pb-2 flex items-center gap-2">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[10px] tracking-[0.3em] font-black" style={{ color: accent }}>
                TABLE CHAT
              </div>
          ...
          >
            ...
            {grouped.map((m) => {
              ...
              const seatColor =
                m.seat_index != null ? SEAT_ACCENTS[m.seat_index % SEAT_ACCENTS.length] : "#94A3B8";
              const initial = (m.display_name || "?").charAt(0).toUpperCase();
              const isEmojiOnly =
                m.kind === "emoji" ||
                (m.body.length <= 4 && /^\p{Extended_Pictographic}+$/u.test(m.body));
              return (
                <div
                  key={m.id}
                ...
                >
                  ...
                  <div
                    className={`min-w-0 max-w-[78%] ${isMine ? "items-end text-right" : "items-start"}`}
                  >
                    {!isMine && (
                      <div
                        className="text-[9px] font-bold mb-0.5 px-1 truncate"
