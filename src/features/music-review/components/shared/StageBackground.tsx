...
export const StageBackground: React.FC = () => (
  <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
    ...
    <div
      ...
      style={{
        background:
          'radial-gradient(circle, rgba(0,183,255,0.35), transparent 60%)',
        filter: 'blur(40px)'
      }}
    />
    <div
      ...
      style={{
        background:
          'radial-gradient(circle, rgba(168,85,247,0.3), transparent 60%)',
        filter: 'blur(40px)'
      }}
    />
    <div
      ...
      style={{
        background:
          'radial-gradient(ellipse, rgba(255,200,87,0.25), transparent 70%)',
        filter: 'blur(60px)'
      }}
    />
    {/* Subtle grid */}
