...
const messages = [
  {
    ...
    from: "TRUNO Pass",
    msg: "Daily login reward: +100 ★ TRUNO Coins",
    time: "2m",
    unread: true,
  },
  {
    ...
    from: "Zay",
    msg: "Invited you to room TR8N-04X2",
    time: "5m",
    unread: true,
  },
  {
    ...
    color: "text-amber-300",
    from: "Night Cup",
    msg: "Registration confirmed — starts in 1h 28m",
    time: "12m",
    unread: true,
  },
  {
    ...
    color: "text-amber-300",
    from: "Season 1",
    msg: "You leveled up to Level 23! Claim your reward.",
    time: "1h",
    unread: true,
  },
  {
    ...
    color: "text-cyan-300",
    from: "Creators Table",
    msg: "New club event tonight at 10 PM CT",
    time: "2h",
    unread: true,
  },
  {
