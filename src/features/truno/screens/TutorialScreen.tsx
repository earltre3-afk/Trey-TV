...
type TipIcon = React.ComponentType<{ size?: number; className?: string }> | (() => React.ReactElement);
...
const tips: Tip[] = [
  { num: 1, label: 'Match Colors', color: 'fuchsia', desc: 'Play a card that matches the color on the table.', Icon: () => <div className="text-2xl">🃏</div> },
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 p-4">
            ...
            {tips.map((t, i) => {
              ...
              return (
                <div key={i} className="flex items-start gap-3 relative">
                  <div className={`w-10 h-10 rounded-full bg-zinc-950 border-2 ${cls} flex items-center justify-center font-black text-sm relative z-10`}>
                    {t.num}
                  </div>
          ...
          <div className="mt-4 rounded-xl border border-fuchsia-500/30 bg-zinc-900/60 p-3">
            ...
            <div className="h-1.5 mt-2 rounded-full bg-zinc-800 overflow-hidden">
              <div className="h-full bg-gradient-to-r from-fuchsia-500 to-purple-500 rounded-full" style={{ width: '0%' }} />
            </div>
            <div className="flex items-center gap-2 mt-3">
              <div className="text-2xl">🎁</div>
              <div className="flex-1">
                <div className="text-[11px] text-zinc-300">Complete all tips to unlock a reward!</div>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 p-4">
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-[11px] text-zinc-400 mt-1 max-w-xs">Play a card that matches the color of the top card on the table.</p>
              </div>
              <div className="flex flex-col items-center">
            ...
            <div className="relative aspect-[4/3] flex items-center justify-center my-3">
              <div className="absolute inset-0 rounded-full" style={{ background: 'radial-gradient(circle, rgba(157,78,221,0.15), transparent 70%)' }} />
              ...
              <div className="flex items-center gap-3">
                <TrunoCard card={{ id: 'd', color: 'black', symbol: 'wild', label: 'W' }} size="sm" faceDown />
                <TrunoCard card={{ id: 't', color: 'blue', symbol: 'number', value: 7, label: '7' }} size="sm" playable />
              </div>
            </div>
            ...
            <div className="mt-4 rounded-xl bg-zinc-900/80 border border-cyan-500/30 p-3 flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[11px] text-zinc-300">Nice! You matched the blue color.<br/>That's how you keep the game going.</p>
              </div>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-zinc-400 font-bold tracking-wider">PRACTICE MODE</span>
                <button onClick={() => setPractice(!practice)} className={`w-10 h-5 rounded-full p-0.5 ${practice ? 'bg-emerald-500' : 'bg-zinc-700'}`}>
                  <div className={`w-4 h-4 rounded-full bg-white transition-transform ${practice ? 'translate-x-5' : ''}`} />
                </button>
              </div>
            </div>
            <p className="text-[11px] text-zinc-400">Practice against AI opponents and sharpen your skills.</p>
            ...
            <div className="flex items-center justify-around">
              ...
              <div className="flex items-center gap-2">
                <TrunoCard card={{ id: 'pd', color: 'black', symbol: 'wild', label: 'W' }} size="sm" faceDown />
                <TrunoCard card={{ id: 'pt', color: 'red', symbol: 'number', value: 2, label: '2' }} size="sm" playable />
              </div>
              <div className="flex flex-col items-center">
                <div className="w-10 h-10 rounded-full bg-cyan-500/20 border border-cyan-500/50 flex items-center justify-center">
                  <Bot size={20} className="text-cyan-300" />
