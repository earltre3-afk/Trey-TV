    ...
    <div className="px-3 pb-24 space-y-4 relative overflow-hidden">
      ...
      <div className="relative flex flex-col items-center">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255,0,128,0.3), rgba(157,78,221,0.2) 40%, transparent 70%)",
          }}
        />
        <div className="relative">
          <Crown
            size={32}
            className="absolute -top-7 left-1/2 -translate-x-1/2 text-amber-400 drop-shadow-[0_0_10px_rgba(255,215,0,0.8)]"
            fill="currentColor"
          />
          <div className="w-32 h-32 rounded-full overflow-hidden ring-4 ring-amber-400 shadow-[0_0_40px_rgba(255,215,0,0.6)]">
            <img
              src={avatarFor("Trey-1")}
              alt="Trey-1"
      ...
      <div className="text-center -mt-2">
        <span className="text-[10px] font-bold text-fuchsia-300 tracking-wider px-3 py-1 rounded-md bg-fuchsia-500/10 border border-fuchsia-500/30">
          FINAL HAND
        </span>
      </div>
      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 p-3 grid grid-cols-3 gap-3 text-center">
        <div>
          <div className="flex items-center justify-center gap-1.5">
            <div className="w-8 h-9 rounded-md border border-fuchsia-500 bg-fuchsia-500/10 flex items-center justify-center text-[10px] font-black text-fuchsia-300">
              XP
            </div>
            <div className="text-left">
              <div className="text-[10px] text-zinc-400 font-bold">XP EARNED</div>
              <div className="text-base font-black text-fuchsia-300">
                +125 <span className="text-xs">XP</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-center gap-1.5">
            ...
            <div className="text-left">
              ...
              <div className="text-base font-black text-white">
                7 <span className="text-xs">DAYS</span>
              </div>
      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 overflow-hidden">
        ...
        {standings.map((s) => (
          <div
            key={s.rank}
            className={`grid grid-cols-[40px_1fr_80px_80px] gap-2 px-3 py-2.5 items-center ${s.rank === 1 ? "bg-gradient-to-r from-amber-500/10 to-transparent border-l-2 border-amber-400" : ""}`}
          >
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              {s.mvp && (
                <span className="text-[9px] px-1.5 py-0.5 rounded-md bg-amber-500/20 border border-amber-500/40 text-amber-300 font-black">
                  MVP
                </span>
              )}
            </div>
      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 p-3 flex items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-xs font-black text-white">
              <span className="text-orange-400">7</span> DAY STREAK
            </div>
        ...
        <div className="flex-1 flex items-center gap-1 px-2">
          ...
          <div className="w-6 h-6 rounded-md border border-amber-500 bg-amber-500/10 flex items-center justify-center text-[10px] font-black text-amber-300">
            7
          </div>
        </div>
        <div className="flex items-center gap-2">
