...
> = {
  red: {
    glow: "shadow-[0_0_30px_rgba(255,51,102,0.6)]",
  ...
  blue: {
    glow: "shadow-[0_0_30px_rgba(0,217,255,0.6)]",
    border: "border-cyan-400",
    bg: "from-blue-900/80 to-blue-950",
    text: "text-cyan-300",
    hex: "#00D9FF",
    energy: "lightning",
  },
  green: {
    glow: "shadow-[0_0_30px_rgba(0,255,136,0.6)]",
  ...
  purple: {
    glow: "shadow-[0_0_30px_rgba(157,78,221,0.7)]",
