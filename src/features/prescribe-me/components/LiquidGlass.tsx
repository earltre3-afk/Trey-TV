...
const accentMap: Record<Accent, { border: string; glow: string; ring: string }> = {
  gold: {
    border: "from-amber-300 via-yellow-400 to-orange-500",
    glow: "shadow-[0_0_40px_-5px_rgba(251,191,36,0.55)]",
    ring: "ring-amber-400/60",
  },
  cyan: {
    border: "from-cyan-300 via-sky-400 to-blue-500",
    glow: "shadow-[0_0_40px_-5px_rgba(34,211,238,0.55)]",
    ring: "ring-cyan-400/60",
  },
  magenta: {
    border: "from-fuchsia-400 via-pink-500 to-rose-500",
    glow: "shadow-[0_0_40px_-5px_rgba(232,121,249,0.55)]",
    ring: "ring-fuchsia-400/60",
  },
  purple: {
    border: "from-purple-400 via-violet-500 to-indigo-500",
    glow: "shadow-[0_0_40px_-5px_rgba(168,85,247,0.55)]",
    ring: "ring-purple-400/60",
  },
  pink: {
    border: "from-pink-400 via-rose-500 to-fuchsia-500",
    glow: "shadow-[0_0_40px_-5px_rgba(244,114,182,0.55)]",
    ring: "ring-pink-400/60",
  },
  orange: {
    border: "from-orange-400 via-amber-500 to-yellow-400",
    glow: "shadow-[0_0_40px_-5px_rgba(251,146,60,0.55)]",
    ring: "ring-orange-400/60",
  },
  multi: {
    border: "from-cyan-400 via-fuchsia-500 to-amber-400",
    glow: "shadow-[0_0_50px_-5px_rgba(217,70,239,0.45)]",
  ...
  return (
    <div
      ...
      className={`relative rounded-3xl p-[1.5px] transition-all duration-300 ${onClick ? "cursor-pointer active:scale-[0.98]" : ""} ${
        selected
          ? `bg-gradient-to-br ${a.border} ${a.glow} ring-2 ${a.ring}`
          : "bg-gradient-to-br from-white/15 via-white/5 to-white/10 hover:from-white/25 hover:via-white/10 hover:to-white/15"
      } ${className}`}
    >
      <div
