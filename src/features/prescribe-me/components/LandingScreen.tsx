        ...
        <LiquidGlassCard accent="multi">
          <div className="px-5 py-6 text-center">
            ...
            <div className="flex items-center justify-center gap-3 mt-3" aria-hidden>
              ...
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" className="text-amber-300">
            ...
            <div className="relative mt-5 mb-5">
              <div className="text-[9px] tracking-[0.23em] text-amber-300/90 uppercase mb-2">How are you feeling?</div>
