...
export type MomentNeed =
  ...
  | "Need a quick watch"
  | "Give me a deep binge"
  | "Make me laugh"
  | "I need something healing"
  | "Put me on something new"
  | "Help me lock in"
  | "I want creator energy"
  | "I want music energy";
...
export const CONTENT_LIBRARY: ContentItem[] = [
  {
    ...
    duration: "medium",
    thumbnail:
      "https://d64gsuwffb70l.cloudfront.net/6a05429725f8777cb511ee72_1778730889867_bfd3e0b6.png",
    contentKind: "video",
    trending: true,
  },
  {
    ...
    duration: "long",
    thumbnail:
      "https://d64gsuwffb70l.cloudfront.net/6a05429725f8777cb511ee72_1778730889057_b6e69acc.png",
  ...
  },
  {
    ...
    duration: "short",
    thumbnail:
      "https://d64gsuwffb70l.cloudfront.net/6a05429725f8777cb511ee72_1778730887832_fbb02db5.png",
  ...
  },
  {
    ...
    duration: "medium",
    thumbnail:
      "https://d64gsuwffb70l.cloudfront.net/6a05429725f8777cb511ee72_1778730891471_29bf970b.png",
    contentKind: "video",
  },
  {
    ...
    duration: "long",
    thumbnail:
      "https://d64gsuwffb70l.cloudfront.net/6a05429725f8777cb511ee72_1778730892607_30c92666.png",
    contentKind: "channel",
  ...
  },
  {
    ...
    duration: "medium",
    thumbnail:
      "https://d64gsuwffb70l.cloudfront.net/6a05429725f8777cb511ee72_1778730894402_923b856a.png",
    contentKind: "channel",
    isNewCreator: true,
  },
  {
    ...
    duration: "medium",
    thumbnail:
      "https://d64gsuwffb70l.cloudfront.net/6a05429725f8777cb511ee72_1778730896949_cc176f8f.png",
    contentKind: "video",
  },
  {
    id: "lock-in-session",
    ...
    duration: "long",
    thumbnail:
      "https://d64gsuwffb70l.cloudfront.net/6a05429725f8777cb511ee72_1778730900195_7a4a14de.png",
    contentKind: "video",
  },
  {
    id: "wild-frequency",
...
export function scoreContent(answers: PrescriptionAnswers): ScoredItem[] {
  ...
  return CONTENT_LIBRARY.map((item) => {
    ...
    const moodMatch =
      moods.length === 0
        ? 70
        : Math.min(100, Math.round((moodHits / moods.length) * 100 + (moodHits > 0 ? 20 : 0)));
    ...
    // Content type match
    const contentMatch =
      contentTypes.length === 0 || contentTypes.includes(item.category) ? 1 : 0.4;
    ...
    const freshness =
      (item.trending ? 4 : 0) +
      (item.isNewCreator && contentTypes.includes("New Creators") ? 6 : 0);
...
export function generatePrescriptionTitle(answers: PrescriptionAnswers): string {
  ...
  if (moods.includes("Healing") || momentNeeds.includes("I need something healing"))
    return "Healing Mode";
