...
import {
  Smile, Cloud, Heart, Zap, Flame, Leaf, Search,
  Target, Frown, Sparkles, Coffee
} from 'lucide-react';

import type { Mood } from './data';

export const MOOD_META: Record<Mood, { color: string; icon: React.ComponentType<{ className?: string; style?: React.CSSProperties }> }> = {
...
const MoodIcon: React.FC<{ mood: Mood; size?: number; className?: string }> = ({ mood, size = 28, className = '' }) => {
