...
export const ReadingScreen: React.FC<Props> = ({
 ...
 <MeterBar label="Trust — Dante" value={branch.meters.trust_dante} color="violet" compact />
 ...
 Chapter {chapter.number} • {branch.chapters.length} chapter{branch.chapters.length === 1 ? '' : 's'} played •{' '}
