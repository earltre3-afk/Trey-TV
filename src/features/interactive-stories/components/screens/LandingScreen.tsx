  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <div className="space-y-6 px-5 pt-6">
        {/* Synopsis */}
        <section>
          <h2 className="mb-2 text-xs font-bold uppercase tracking-widest text-violet-400">
            Synopsis
          </h2>
          <p className="font-serif text-base leading-relaxed text-white/80">
            Identical twins. Malik is the football star with a draft showcase coming. Micah is the
            ballet dancer with an adjudication for a featured solo. After a recreationally unwise
            night, one panicked favor turns into the longest day of their lives — and every choice
            you make decides who finds out, who falls in love, and who survives the truth.
          </p>
        </section>

        {/* Cast */}
        <section>
          <h2 className="mb-3 text-xs font-bold uppercase tracking-widest text-violet-400">
            The Cast
          </h2>
        ...
        {lastBranch && (
          <section className="rounded-2xl border border-violet-500/30 bg-violet-500/5 p-4">
            ...
            <div className="text-sm text-white/60 line-clamp-2">
              {lastBranch.chapters[lastBranch.chapters.length - 1]?.summary ||
        ...
        >
          <span className="relative z-10 inline-flex items-center gap-3">
            {activeBranches.length > 0 ? (
              ...
              <>
                <Play className="h-5 w-5 fill-current" /> Start Story
              </>
            )}
          </span>
