...
export const PlaythroughsScreen: React.FC<Props> = ({
  ...
  const completedCount = useMemo(
    () => metas.filter((m) => m.status === "completed").length,
    [metas],
  );
  ...
  return (
    <div className="min-h-screen pb-28">
      <header className="px-5 pt-10 pb-4">
        <div className="text-[10px] font-bold uppercase tracking-[0.3em] text-violet-400">
          My Playthroughs
        </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          ...
          <div className="rounded-2xl border border-amber-500/30 bg-amber-500/10 p-3">
            ...
            <div className="mt-1 font-display text-2xl font-black text-amber-200">
              {completedCount}
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-black pb-24">
      ...
      <div className="px-5 pt-24">
        {loading ? (
          <div className="text-center text-white/60">Loading shared ending…</div>
        ) : !data ? (
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center text-white/70">
            This shared ending isn't available — it may have been made private.
          </div>
        ) : (
          <div className="overflow-hidden rounded-3xl border border-amber-500/30 bg-gradient-to-br from-zinc-900 to-black shadow-2xl shadow-amber-500/10">
            <div className="relative h-56">
              <img
                src={
                  data.ending_card_image ||
                  data.cover_image ||
                  "https://d64gsuwffb70l.cloudfront.net/6a0575852fdc9c6f0e9154fd_1778778646387_303e8c18.png"
                }
