  ...
  return (
    <div className="relative min-h-screen pb-24">
      ...
      <div className="px-5">
        ...
        {(() => {
          ...
          return (
            <div className="mt-4 flex items-center gap-2 rounded-2xl border border-white/10 bg-black/40 p-2.5 backdrop-blur-md">
              ...
              <span className="text-[11px] text-white/60">{cast.map((c) => c.firstName).join(' Â· ')}</span>
            </div>
          );
        })()}
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  {/* Character faces â€” neon-ringed circular avatars */}
                  {affected.length > 0 && (
        ...
        <div className="mt-6">
          <div className="mb-2 text-xs font-bold uppercase tracking-widest text-white/50">Or type your ownâ€¦</div>
