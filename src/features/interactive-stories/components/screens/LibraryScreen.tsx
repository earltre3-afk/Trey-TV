      ...
      <header className="px-5 pt-10 pb-6">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            Endings{" "}
            {endingsCount > 0 && (
              <span className="rounded-full bg-amber-500 px-1.5 text-[10px] text-black">
                {endingsCount}
              </span>
            )}
          </button>
        ...
        >
          <div className="relative aspect-[3/4] w-full">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              <div className="font-display text-xs uppercase tracking-[0.3em] text-amber-400">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          >
            ...
            <div className="min-w-0 flex-1 py-1">
              ...
              <p className="mt-1 line-clamp-2 text-xs leading-relaxed text-white/55">
                Craft your own unique story, define your characters, and let the AI generate a fully
                custom interactive adventure.
              </p>
          ...
          <div className="rounded-3xl border border-violet-500/30 bg-gradient-to-br from-violet-500/10 via-black/70 to-fuchsia-500/10 p-4 shadow-lg shadow-violet-500/10">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[10px] font-bold uppercase tracking-[0.25em] text-violet-300">
                  Story Installer
                </div>
                <h3 className="font-display text-xl font-black text-white">
                  Install a .ttstory file
                </h3>
          ...
          {[
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-3">
                <div className="text-[10px] font-bold uppercase tracking-widest text-amber-400/70">
                  {s.tag}
                </div>
