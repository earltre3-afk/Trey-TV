...
export const StatusPanel: React.FC<Props> = ({ branch, open, onClose }) => {
 ...
 <MeterBar label="Malik → Micah" value={branch.meters.trust_malik_to_micah} color="emerald" />
 <MeterBar label="Micah → Malik" value={branch.meters.trust_micah_to_malik} color="emerald" />
 </div>
