...
export const SCENARIOS: Scenario[] = [
  {
    ...
    imageAlt: 'Two close friends at a dusk gas station beside a road trip car, one asking for help while the other checks money and looks conflicted.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A young adult alone at night on a couch, hurt while reading a vague social post on their phone after trusting a close friend.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A tense family dinner where a young adult sits under pressure while relatives react to a comment about chasing dreams.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A tired young adult taking another late-night emotional phone call from a friend repeating the same relationship pattern.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A tense late-night rideshare from the back seat, with the passenger watching the route on a low-battery phone as the driver takes a darker road.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A couple sits apart in a dim living room, one withdrawn and avoiding eye contact while the other tries to understand what changed.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A young performer near a stage entrance being handed a microphone with a packed crowd glowing in the background.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'Two stylish young adults in a studio mirror setup where one clearly imitates the other’s pose, color palette, and content aesthetic.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A concerned visitor stands in a dim, cluttered apartment while a tired friend sits on the couch surrounded by dishes and heavy energy.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A young adult in bed at night overwhelmed by glowing social notifications after a personal post goes viral.',
    scenarioBody:
  ...
  },
  {
    ...
    imageAlt: 'A young adult sits awake in a dim bedroom holding a phone after a dream about an old friend felt too real to ignore.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'A small group laughs awkwardly in a living room while a young adult absorbs a joke that touched a private insecurity.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'A tired young adult sits on the edge of a messy bed in a cluttered room, overwhelmed before the day even begins.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'A young adult listens from a doorway while people in the next room talk unfairly about a friend without noticing him.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'A stylish young adult checks himself in the mirror with clothes laid out, deciding whether to go somewhere after learning an old conflict will be there.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'A young adult explains a big idea at a table with a laptop and sketches while someone close listens skeptically.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'An exhausted young adult sits in a dim room on a phone call, conflicted between helping a friend and having nothing left to give.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'A young adult stands at the entrance of a crowded social gathering, reading the room while strangers look back at him.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'A tired young adult sits alone at night holding a phone after receiving a long emotional voice memo from a friend.',
    customOption: true,
    choices: [
      {
        id: 'A',
  ...
  },
  {
    ...
    imageAlt: 'A young adult stands near an open doorway with a packed bag and phone, facing a life-changing opportunity and the old life he must leave behind.',
    customOption: true,
    choices: [
      {
        id: 'A',
