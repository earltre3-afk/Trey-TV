...
export const POLICY_INDEX: { slug: string; title: string; summary: string; category: LegalPolicy["category"]; icon: string }[] = [
...
export const POLICIES: Record<string, LegalPolicy> = {
  ...
  "content-policy": {
    ...
    category: "user",
    summary:
      "Rules for what can be posted, uploaded, and broadcast on Trey TV.",
    sections: [
  ...
  "cookie-policy": {
    ...
    category: "core",
    summary:
      "How Trey TV uses cookies, local storage, and similar technologies.",
    sections: [
  ...
  dmca: {
    ...
    category: "core",
    summary:
      "How to report copyright infringement on Trey TV and how we handle takedown notices.",
    sections: [
  ...
  accessibility: {
    ...
    category: "support",
    summary:
      "Trey TV is committed to building an accessible, inclusive entertainment experience.",
    sections: [
  ...
  "ai-disclosure": {
    ...
    category: "ai",
    summary:
      "How Trey-I works, what data it processes, and what it should not be used for.",
    sections: [
