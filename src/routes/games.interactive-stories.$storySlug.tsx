...
export const Route = createFileRoute("/games/interactive-stories/$storySlug")({
  component: StorySlugPage,
  head: () => ({
    meta: [
      { title: "Playing Story · Trey TV Games" },
      { name: "description", content: "Play this interactive story on Trey TV." },
    ],
  }),
});

function StorySlugPage() {
  const { storySlug } = useParams({ from: "/games/interactive-stories/$storySlug" });
        ...
        fallback={
          <div className="min-h-screen w-full flex items-center justify-center px-6">
            ...
            >
              ...
              <div className="mt-1 text-base font-black">Loading Story</div>
            </div>
          </div>
        }
      >
