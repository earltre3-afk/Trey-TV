            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-semibold flex items-center gap-1 truncate">
                  {u.display_name || u.username} <Crown className="size-3 text-primary" />{" "}
                  {u.gold_verified && <BadgeCheck className="size-3 text-primary" />}
                </div>
              ...
              {isPublicProfileUid(u.public_profile_uid) && (
                <Link
                  ...
                  className="px-3 py-1.5 rounded-lg text-xs font-semibold glass border border-white/10"
                >
                  View
                </Link>
              )}
              <button
                onClick={() => revoke(u)}
                className="px-3 py-1.5 rounded-lg text-xs font-semibold glass border border-rose-400/40 text-rose-300 hover:bg-rose-400/10"
              >
                Revoke
              </button>
            </div>
