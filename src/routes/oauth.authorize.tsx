    ...
    return (
      <OAuthShell>
        <div className="text-center text-sm text-muted-foreground">
          Preparing Trey TV authorization...
        </div>
      </OAuthShell>
    );
  }
      ...
      <div className="rounded-[28px] liquid-glass neon-border p-6 sm:p-8">
        <div className="text-center">
          ...
          <h1 className="mt-3 text-3xl sm:text-4xl font-black">
            Allow {app.app_name} to use your Trey TV account?
          </h1>
          <p className="mt-3 text-sm text-muted-foreground">
            {app.app_name} will not receive your Trey TV password.
          </p>
        </div>
        ...
        <div className="mt-6 rounded-2xl bg-white/[0.04] border border-white/10 p-4">
          ...
          <div className="mt-3 space-y-2">
            <Permission
              show={scopes.includes("profile:read") || scopes.includes("public_uid:read")}
              icon={User}
              text="View your public Trey TV profile"
            />
            <Permission
              show={scopes.includes("email:read")}
              icon={Mail}
              text="View your email address"
            />
            <Permission
              show={scopes.includes("creator:read")}
              icon={ShieldCheck}
              text="View your creator status"
            />
            <Permission
              show={scopes.includes("verification:read")}
              icon={Check}
              text="View your gold verification status"
            />
          </div>
        </div>
