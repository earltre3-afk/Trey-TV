...
function StoryBranchesPage() {
  return (
    <div className="font-sans antialiased" style={{ background: "#05070D", color: "#F8FAFC", minHeight: "100vh" }}>
      <Suspense fallback={<div className="min-h-screen grid place-items-center text-white">Loading Branch Map</div>}>
        <InteractiveStoriesPlayer initialView="main" initialTab="branches" onBack={() => window.history.back()} />
      </Suspense>
    </div>
  );
}
