      ...
      <div className="relative max-w-md w-full rounded-3xl glass neon-border p-8 text-center overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Your episode has been submitted for admin approval. You'll be notified when it's
            approved, rejected, or needs changes.
          </p>
          <div className="mt-6 flex flex-col gap-2">
            <Link
              to="/creator-studio/submissions"
              className="px-4 py-3 rounded-xl text-sm font-bold bg-primary text-primary-foreground glow-gold flex items-center justify-center gap-2"
            >
              <Eye className="size-4" /> View Submission Status
            </Link>
            <Link
              to="/creator-studio/edit"
              className="px-4 py-3 rounded-xl text-sm font-semibold glass border border-white/10 flex items-center justify-center gap-2"
            >
