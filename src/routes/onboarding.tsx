  ...
  head: () => ({
    meta: [
      { title: "Welcome to Trey TV" },
      {
        name: "description",
        content:
          "Choose your path into the Trey TV universe — voice setup with Trey-I or manual signup.",
      },
    ],
  }),
});
      ...
      <div className="relative max-w-[1100px] mx-auto px-4 lg:px-8 pt-10 pb-16">
        <div className="text-center space-y-3 animate-rise">
          ...
          <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
            Talk it out with Trey-I or set things up the classic way. Either road takes you to the
            same premium universe.
          </p>
        </div>
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-5">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="mt-4 text-[10px] tracking-[0.3em] text-primary">
                RECOMMENDED · VOICE
              </div>
              <h3 className="mt-1 text-2xl font-bold">Setup with Trey-I</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Have a natural conversation. Trey-I asks the right questions and builds your profile
                while you talk. Cinematic, fast, and zero forms.
              </p>
              <ul className="mt-4 space-y-1.5 text-xs text-muted-foreground">
                <li className="flex items-center gap-2">
                  <Sparkles className="size-3 text-primary" /> Voice-first onboarding
                </li>
                <li className="flex items-center gap-2">
                  <Wand2 className="size-3 text-[oklch(0.7_0.25_340)]" /> Auto-generated bio +
                  accent
                </li>
                <li className="flex items-center gap-2">
                  <Eye className="size-3 text-[oklch(0.82_0.15_215)]" /> Live profile preview
                </li>
              </ul>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="mt-4 text-[10px] tracking-[0.3em] text-[oklch(0.82_0.15_215)]">
                CLASSIC · MANUAL
              </div>
              <h3 className="mt-1 text-2xl font-bold">Manual Setup</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                The familiar flow. Enter your info, pick your interests, finish setup. Just
                polished.
              </p>
              <ul className="mt-4 space-y-1.5 text-xs text-muted-foreground">
                <li className="flex items-center gap-2">
                  <Sparkles className="size-3 text-[oklch(0.82_0.15_215)]" /> Step-by-step form
                </li>
                <li className="flex items-center gap-2">
                  <Crown className="size-3 text-primary" /> Choose your role on signup
                </li>
                <li className="flex items-center gap-2">
                  <Eye className="size-3 text-[oklch(0.7_0.25_340)]" /> Visual preview at the end
                </li>
              </ul>
          ...
          >
            ...
            <div className="relative flex flex-col sm:flex-row sm:items-center gap-5">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[10px] tracking-[0.3em] text-[oklch(0.78_0.18_150)]">
                  FAST · IMPORT
                </div>
                <h3 className="mt-0.5 text-xl font-bold">Import From Screenshot</h3>
                <p className="mt-1 text-sm text-muted-foreground">
                  Upload a screenshot of your public profile and Trey TV will turn it into a profile
                  draft you can edit before publishing.
                </p>
                <ul className="mt-3 flex flex-wrap gap-x-5 gap-y-1 text-xs text-muted-foreground">
                  <li className="flex items-center gap-1.5">
                    <ImageIcon className="size-3 text-[oklch(0.78_0.18_150)]" /> Upload your
                    screenshot
                  </li>
                  <li className="flex items-center gap-1.5">
                    <Sparkles className="size-3 text-primary" /> AI extracts your profile info
                  </li>
                  <li className="flex items-center gap-1.5">
                    <Eye className="size-3 text-[oklch(0.82_0.15_215)]" /> Review &amp; edit before
                    publishing
                  </li>
                </ul>
              </div>
