...
function ReviewDetail() {
    ...
    return (
      <AdminShell title="Submission not found">
        <Link
          ...
          className="px-3 py-2 rounded-xl glass border border-white/10 text-sm inline-flex items-center gap-2"
        >
  ...
  return (
    <AdminShell
      ...
      subtitle={`@${sub.creator_handle} · ${sub.show_title} · S${sub.season_number} E${sub.episode_number}`}
    >
      <Link
        to="/admin/content-approval"
      ...
      <div className="grid lg:grid-cols-[1.6fr,1fr] gap-4">
        ...
        <div className="space-y-4">
          <div className="rounded-3xl glass neon-border overflow-hidden">
            <div className="relative aspect-video bg-black">
              {sub.video_url?.startsWith("blob:") ? (
                ...
                <img
                  src={sub.thumbnail_url || posts[0].media}
                  className="absolute inset-0 size-full object-cover"
                  alt=""
                />
              )}
              <span
                className={`absolute top-3 left-3 text-[10px] px-2 py-0.5 rounded-full border ${STATUS_TONE[sub.status]}`}
              >
          ...
          <section className="rounded-3xl glass neon-border p-4 space-y-3">
            <div>
              ...
              <textarea
                ...
                placeholder="Visible to the creator if you request changes or reject."
              />
            </div>
            <div>
              <div className="text-[10px] tracking-[0.2em] text-muted-foreground uppercase mb-1.5">
              ...
              <button
                ...
                className="mt-2 px-3 py-1.5 rounded-lg text-xs font-semibold glass border border-white/10"
              >
          ...
          <section className="rounded-3xl glass neon-border p-4 flex flex-wrap gap-2">
            ...
            >
              <Globe2 className="size-3.5" /> Approve & Publish
            </button>
            <button
              onClick={() => {
                review("approved", internal, "Approved");
              }}
              className="px-3 py-2 rounded-xl text-xs font-bold glass border border-[oklch(0.78_0.18_150_/_0.4)] text-[oklch(0.82_0.18_150)] flex items-center gap-1"
            >
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className="px-3 py-2 rounded-xl text-xs font-bold glass border border-[oklch(0.65_0.22_300_/_0.4)] text-[oklch(0.78_0.22_300)] flex items-center gap-1"
              >
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl text-xs font-bold glass border border-[oklch(0.7_0.25_340_/_0.4)] text-[oklch(0.78_0.25_340)] flex items-center gap-1"
            >
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl text-xs font-bold glass border border-[oklch(0.65_0.24_15_/_0.4)] text-[oklch(0.78_0.24_15)] flex items-center gap-1"
            >
              <X className="size-3.5" /> Reject
            </button>
            <Link
              to="/watch/$id"
              params={{ id: sub.content_id }}
              className="px-3 py-2 rounded-xl text-xs font-bold glass border border-white/10 flex items-center gap-1"
            >
              <Eye className="size-3.5" /> Preview public page
            </Link>
          </section>
        </div>
