    ...
    <div className="min-h-screen w-full bg-[#06050A] flex flex-col items-center justify-center relative overflow-hidden select-none">
      ...
      <div className="relative flex flex-col items-center gap-6 z-10 text-center px-4 animate-pulse">
        <div className="relative group">
          <span
            aria-hidden="true"
            className="absolute inset-0 -m-6 rounded-full bg-purple-500/15 blur-2xl animate-glow-pulse"
          />
          <div className="relative w-20 h-20 rounded-full border border-white/10 bg-black/45 backdrop-blur-md p-3.5 grid place-items-center shadow-[0_0_30px_rgba(0,0,0,0.5)]">
            <svg
              className="w-10 h-10 text-fuchsia-400 animate-spin"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
        ...
        <div className="space-y-2">
          <div
            className="text-3xl font-black tracking-[0.25em] bg-gradient-to-r from-fuchsia-400 via-purple-300 to-cyan-400 bg-clip-text text-transparent"
            style={{ filter: "drop-shadow(0 0 12px rgba(217,70,239,0.4))" }}
          >
            TRADIO
          </div>
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/40 leading-none">
            TUNING TO THE MUSIC WORLD
          </p>
        </div>
