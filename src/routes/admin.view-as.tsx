...
function ViewAs() {
  ...
  return (
    <AdminShell title="View As" subtitle="Preview the app from any perspective. Real permissions are unchanged.">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        {opts.map((o) => (
          ...
          >
            <div className="size-10 rounded-xl bg-primary/15 text-primary grid place-items-center"><o.icon className="size-4" /></div>
