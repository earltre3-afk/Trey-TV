...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Creatorverse Network is a premium creator entertainment platform for building and discovering shows, seasons, and episodes." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Creatorverse Network is a premium creator entertainment platform for building and discovering shows, seasons, and episodes." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Creatorverse Network is a premium creator entertainment platform for building and discovering shows, seasons, and episodes." },
