    ...
    <AppShell>
      <div className="space-y-6 -mt-2">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => toast.success("New collection")}
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm border border-primary/40 text-primary glow-gold tilt-press"
          >
        ...
        <div className="relative rounded-3xl glass-strong border border-white/10 p-5 overflow-hidden">
          ...
          <div className="relative flex items-center gap-3">
            <div className="size-12 grid place-items-center rounded-2xl bg-primary/15 text-primary glow-gold">
              <Bookmark className="size-6" />
            </div>
            <div>
              <h1 className="text-2xl font-bold">Your Collections</h1>
              <p className="text-xs text-muted-foreground">
                Curated stacks of saved posts, episodes and prescriptions.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="absolute bottom-3 left-3 right-3">
                <div className="text-sm font-semibold flex items-center gap-1">
                  {c.name} {c.private && <Lock className="size-3 text-muted-foreground" />}
                </div>
