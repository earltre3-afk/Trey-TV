...
const stationLaunch: {
...
}[] = [
  {
    key: "build",
    title: "Build Station",
    sub: "Generate a mood, catalog, or creator-led radio lane.",
    Icon: Sparkles,
  },
  {
    key: "artist",
    title: "Artist Stations",
    sub: "Explore artist-owned channels and official rotations.",
    Icon: Radio,
  },
  {
    key: "schedule",
    title: "Live Schedule",
    sub: "Premieres, DJ shows, beat spotlights, and replays.",
    Icon: CalendarDays,
  },
  {
    key: "community",
    title: "Station Community",
    sub: "Requests, votes, chat, badges, and fan moments.",
    Icon: MessageCircle,
  },
];
          ...
          <div className="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="mt-4 text-3xl font-black tracking-tight text-white sm:text-4xl">
                Stations are alive now
              </h1>
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-white/65">
                Build AI stations, enter artist-owned channels, follow live programming, and
                participate with the fan community.
              </p>
              {onOpenBroadcastStudio && (
                <SecondaryButton
                  onClick={() => onOpenBroadcastStudio("builder")}
                  className="mt-4 text-xs font-bold bg-purple-500/10 border-purple-500/25 hover:bg-purple-500/20"
                >
                  <Radio className="h-3.5 w-3.5 text-purple-300 animate-pulse" /> Start A Radio
                  Experience
                </SecondaryButton>
              )}
            </div>
    ...
    <div className="px-4 sm:px-6 lg:px-10">
      <div className="mb-4">
        ...
        <div className="text-xs text-white/50">
          Cinematic head-to-head battles and live radio voting events
        </div>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-white/60">
                Watch Trey Trizzy, Kiana Lane and other creators clash going song-for-song.
              </div>
            </div>
          </div>
          <button
    ...
    <div>
      <div className="mb-3 flex items-center justify-between px-4 sm:px-6 lg:px-10">
        <div>
          ...
          <div className="text-xs text-white/50">
            Official channels, premieres, and fan-led requests
          </div>
        </div>
        <SecondaryButton className="px-3 py-2 text-xs" onClick={() => onOpen("build")}>
