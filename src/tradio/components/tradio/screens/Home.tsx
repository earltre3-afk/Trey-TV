...
import { DeferredHomeSection } from "../DeferredHomeSection";
import {
  IMG,
  FEATURED_STATIONS,
  ARTIST_STATIONS,
...
export const HomeScreen: React.FC<Props> = ({
  ...
  return (
    <div className="flex flex-col gap-5 pb-5 lg:gap-6 lg:pb-6 [&>*]:order-10">
      ...
      <DeferredHomeSection
        label="Tradio Pathway"
        minHeight={250}
        rootMargin="0px"
        className="!order-4 px-4 sm:px-6 lg:px-10 animate-fade-in"
        render={() => (
      ...
      <DeferredHomeSection
        label="Prescribe My Music"
        minHeight={180}
        rootMargin="0px"
        className="!order-5 px-4 sm:px-6 lg:px-10"
        render={() => (
          <PrescriptionRail
            compact
            ...
            render={() => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1 text-[11px] leading-relaxed text-white/50">
                    Continuously listening. Always perfect. Tradio mixes what you love with what
                    you'll love next.
                  </p>
                </div>
