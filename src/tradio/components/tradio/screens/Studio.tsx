...
const launchCards: {
...
}[] = [
  {
    ...
    eyebrow: "Invite-Only Suite",
    description: "Build live shows, DJ mixes, station premieres, and AI-powered radio experiences.",
    Icon: Radio,
  ...
  },
  {
    ...
    description: "Manage releases, playlists, fan drops, and station premieres.",
    Icon: Music2,
  ...
  },
  {
    key: "producerHub",
    title: "Producer Hub",
    eyebrow: "Beat Network",
    description: "Upload beats, package catalogs, pitch artists, and reach DJs.",
    Icon: Disc3,
  ...
  },
  {
    ...
    title: "DJ Studio",
    eyebrow: "Broadcast",
    description: "Build live shows, schedule mixes, handle requests, and archive replays.",
    Icon: Mic2,
    capability: "host-song-war",
  },
  {
    key: "showBuilder",
    title: "AI Show Builder",
    eyebrow: "Live AI",
    description: "Generate full radio timelines with host notes, music blocks, and ad slots.",
    Icon: Wand2,
  },
  {
    key: "release",
    ...
    eyebrow: "Drop Music",
    description: "Publish or schedule a track directly into Tradio stations.",
    Icon: UploadCloud,
    capability: "release-music",
  },
  {
    ...
    title: "Analytics",
    eyebrow: "Pulse",
    description: "Track plays, saves, fan growth, release momentum, and station health.",
    Icon: BarChart3,
  },
  {
    key: "legalAdmin",
    ...
    description:
      "Review legal intake, privacy requests, appeals, deletion queue, and acceptance audit records.",
    Icon: Gavel,
...
> = {
  listener: [
    {
      ...
      sub: "Jump back into followed stations.",
      icon: <Heart className="h-4 w-4" />,
      destination: "analytics",
    },
    {
      title: "Fan Communities",
      sub: "Requests, chat, polls, and reactions.",
      icon: <Users className="h-4 w-4" />,
      destination: "songwars",
    },
    {
      title: "Request Broadcast Access",
      sub: "Prepare the premium host application.",
      icon: <Radio className="h-4 w-4" />,
      destination: "broadcastStudio",
      capability: "request-broadcast-access",
    },
  ],
  artist: [
    {
      title: "Instant Release",
      sub: "Drop or schedule music.",
    ...
    },
    {
      ...
      sub: "Manage station premieres.",
      icon: <Radio className="h-4 w-4" />,
      destination: "artistHub",
      capability: "create-artist-station",
    },
    {
      title: "Release Analytics",
      sub: "Track fans, saves, and station lift.",
  ...
  producer: [
    {
      title: "Beat Catalog",
      sub: "Upload, tag, and pitch beats.",
    ...
    },
    {
      ...
      sub: "Send beat packs to live shows.",
      icon: <Radio className="h-4 w-4" />,
      destination: "producerHub",
      capability: "upload-beat",
    },
    {
      ...
      sub: "Build a featured broadcast block.",
  ...
  dj: [
    {
      title: "Go Live Desk",
      sub: "Shows, mixes, requests, and replay archive.",
    ...
    {
      title: "Live Schedule",
      sub: "Plan blocks and upcoming broadcasts.",
      icon: <CalendarDays className="h-4 w-4" />,
      destination: "djStudio",
    },
    {
      title: "Song Wars Hosting",
      sub: "Open host controls for battle sessions.",
      icon: <Radio className="h-4 w-4" />,
      destination: "songwars_stage",
      capability: "host-song-war",
    },
  ],
  admin: [
    {
      title: "Manage Broadcast Access",
      sub: "Review requests and grants.",
      icon: <ShieldCheck className="h-4 w-4" />,
      destination: "broadcastStudio",
      capability: "admin-platform",
    },
    {
      title: "Manage Song Wars",
      sub: "Feature, moderate, and archive battles.",
      icon: <Radio className="h-4 w-4" />,
      destination: "songwars",
      capability: "admin-platform",
    },
    {
      title: "Legal Operations",
      sub: "Review intake, DMCA, appeals, deletion, and audit queues.",
      icon: <Gavel className="h-4 w-4" />,
      destination: "legalAdmin",
      capability: "admin-platform",
    },
  ],
};
...
export const StudioScreen: React.FC<{
  ...
  const visibleLaunchCards = launchCards.filter(
    (card) => cardsByMode[currentMode].includes(card.key) || currentMode === "admin",
  );
  ...
  return (
    <div className="space-y-8 pb-4 lg:space-y-10">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-relaxed text-white/65">
                Operating as {currentRoleLabel}. Tradio mode changes visible creator, broadcast, and
                moderation tools without changing the shared Trey TV profile.
              </p>
            </div>
      ...
      <div className="px-4 sm:px-6 lg:px-10">
        <SignalTestEntryCard
          state={SIGNAL_TEST_STATE}
          onStart={messengerBridge?.parentHandlers.onOpenSignalTest}
        />
      </div>
          ...
          {[
            {
              ...
              destination: "artistProfile" as StudioDestination,
              Icon: Music2,
            },
            {
              role: "producer" as const,
              label: "Producer Profile",
              destination: "producerProfile" as StudioDestination,
              Icon: Disc3,
            },
            {
              role: "dj" as const,
              label: "DJ / Host Profile",
              destination: "djProfile" as StudioDestination,
              Icon: Mic2,
            },
              ...
              <GlassCard className="flex items-center gap-3 p-4 transition-all duration-300 group-hover:border-purple-300/30 group-hover:bg-purple-500/[0.04]">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[11px] text-white/50">
                    Activation-aware · owner & public view
                  </div>
                </div>
              </GlassCard>
            </button>
        ...
        <div className="mb-3 flex items-center justify-between">
          <div>
            ...
            <div className="text-xs text-white/50">
              {MODE_LABELS[currentMode]} surfaces the tools that match your active lane
            </div>
          </div>
              ...
              <button key={key} onClick={() => allowed && open(key)} className="group text-left">
                <GlassCard className="h-full p-4 transition-all duration-300 group-hover:border-purple-300/30 group-hover:bg-purple-500/[0.04]">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span className="rounded-full border border-white/10 bg-white/[0.04] px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-white/45">
                      {allowed ? eyebrow : "Locked"}
                    </span>
                  </div>
                  <div className="mt-4 text-lg font-bold text-white">{title}</div>
                  <p className="mt-2 min-h-[42px] text-sm leading-relaxed text-white/62">
                    {description}
                  </p>
                  <div className="mt-4 flex items-center gap-2 text-xs font-semibold text-cyan-300">
                    {allowed ? "Open module" : "Switch/request access"}{" "}
          ...
          return (
            <GlassCard key={item.title} className="p-4">
              <div className="flex items-start gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.05] text-purple-200">
                  {item.icon}
                </div>
                <div className="min-w-0 flex-1">
                  ...
                  <button
                    onClick={() => allowed && open(item.destination)}
                    className={`mt-3 text-xs font-bold ${allowed ? "text-cyan-300" : "text-white/35"}`}
                  >
      ...
      {(canRequestBroadcastAccess(identity) || can(identity, "request-verification")) && (
        <div className="px-4 sm:px-6 lg:px-10">
          <ApplyForAccessCTA
            type={canRequestBroadcastAccess(identity) ? "broadcast" : "verification"}
          />
        </div>
      )}
      ...
      <div className="px-4 sm:px-6 lg:px-10">
        <PrescriptionRail
          title={
            currentMode === "artist"
              ? "Prescribe my next release strategy"
              : currentMode === "producer"
                ? "Prescribe artists for this beat"
                : currentMode === "dj"
                  ? "Prescribe tonight's show flow"
                  : currentMode === "admin"
                    ? "Prescribe platform moves"
      ...
      <div className="px-4 sm:px-6 lg:px-10">
        <div className="mb-4">
          ...
          <div className="text-xs text-white/50">
            Launch, configure, and control live PvP battle sessions
          </div>
        </div>
        <div className="grid gap-3 sm:grid-cols-3">
          {[
            {
              title: "Create Song War",
              sub: "Setup round constraints, choose competitors, select tracks, and schedule.",
              action: "songwars_setup",
              badge: "Creator",
              capability: "access-studio" as TradioCapability,
            },
            {
              title: "Manage Battles",
              sub: "Archive sessions, update badges, override ledger winner, or feature battles.",
              action: "songwars",
              badge: "Admin Only",
              capability: "admin-platform" as TradioCapability,
            },
            {
              title: "Host Battle Session",
              sub: "Open live voting, queue tracks, reveal round winners, and trigger ad breaks.",
              action: "songwars_stage",
              badge: "DJ / Host",
              capability: "host-song-war" as TradioCapability,
            },
          ].map((item) => {
            ...
            return (
              <GlassCard
                key={item.title}
                className="flex flex-col justify-between p-4 transition-all hover:border-purple-500/25 hover:bg-purple-500/[0.02]"
              >
                <div>
                  <span className="inline-block rounded border border-purple-400/20 bg-purple-500/10 px-2 py-0.5 text-[9px] font-black uppercase tracking-widest text-purple-300">
                    {item.badge}
                  </span>
      ...
      <div className="grid gap-3 px-4 sm:px-6 lg:grid-cols-[1fr_0.8fr] lg:px-10">
        <GlassCard className="p-4">
          ...
          <div className="grid gap-2 sm:grid-cols-3">
            {[
              [
                "Release to Tradio",
                "Push a track into station rotation.",
                "release",
                "release-music",
              ],
              ...
              return (
                <button
                  key={title}
                  onClick={() => allowed && open(key as StudioDestination)}
                ...
                >
                  ...
                  {!allowed && (
                    <div className="mt-2 text-[10px] font-bold uppercase tracking-wider text-white/35">
                      Access required
                    </div>
                  )}
                </button>
        ...
        <GlassCard className="p-4">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {identity.roles.map((grant) => (
              <Chip
                key={grant.id}
                label={`${grant.role} ${grant.role_status}`}
                selected={grant.role_status === "active"}
              />
            ))}
          </div>
          ...
          <SecondaryButton
            ...
            onClick={() => can(identity, "release-music") && open("release")}
          >
