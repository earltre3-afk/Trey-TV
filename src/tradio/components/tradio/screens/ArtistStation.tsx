    ...
    <div className="space-y-8 pb-4 lg:space-y-10">
      ...
      <div className="relative">
        <img
          src={IMG.treyTrizzy}
          alt=""
          className="absolute right-0 top-0 h-[280px] w-full object-cover opacity-90"
        />
        ...
        <div className="relative px-4 pt-2 sm:px-6 lg:px-10">
          ...
          <h1 className="mt-3 text-[44px] font-black leading-[0.95] tracking-tight text-white">
            ...
            TRIZZY
            <br />
            <span className="text-fuchsia-400">RADIO</span>
          </h1>
          ...
          <p className="mt-3 max-w-[70%] text-sm text-white/70">
            The official station. The real me. No skips.
          </p>
      ...
      <div className="px-4 sm:px-6 lg:px-10">
        <GlassCard className="grid grid-cols-4 gap-2 p-4">
          {[
            ...
            {
              icon: <Radio className="h-4 w-4 text-purple-300" />,
              value: "24/7",
              label: "Always On",
            },
            {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/50">
                    Pitch a PvP Song War. Go song-for-song with live fan voting.
                  </p>
                </div>
              </div>
      ...
      <div className="space-y-3 px-4 sm:px-6 lg:px-10">
        <GlassCard className="p-4">
          ...
          <p className="mt-2 text-sm leading-relaxed text-white/75">
            Trey Trizzy Radio is where you'll hear the music that inspires me, the sounds I'm
            creating, and the vibes I live by. Hip-hop. Trap. Real stories. No filters.
          </p>
      ...
      {/* Current rotation */}
      <div className="px-4 sm:px-6 lg:px-10">
        <div className="mb-2 text-[11px] font-bold tracking-wider text-white/60">
          CURRENT ROTATION
        </div>
        <GlassCard className="divide-y divide-white/5">
          {ROTATION.map((r, i) => {
            ...
            return (
              ...
              >
                <span
                  className={`w-5 text-sm font-semibold ${live ? "text-purple-300" : "text-white/50"}`}
                >
                  {r.n}
                </span>
                ...
                <div className="min-w-0 flex-1">
                  <div
                    className={`truncate text-sm font-semibold ${live ? "text-purple-300" : "text-white"}`}
                  >
                    {r.title}
                  </div>
