...
export const REFINEMENT_OPTIONS = [
  ...
  { id: 'familiar', label: 'Make it more familiar', description: 'Tune closer to your current catalog saves' },
  ...
  { id: 'no_song_wars', label: 'Remove Song Wars', description: 'Filter out active PvP voting grids' },
  { id: 'producer_dj', label: 'Include producer/DJ content', description: 'Incorporate exclusive beat packs and transition guides' },
];
