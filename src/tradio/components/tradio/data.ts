...
export const IMG = {
  // Album/Station Art
  aiSphere:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986662442_13f29141.png",
  midnightVelvet:
  ...
  treyTrizzy:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986727359_90668e12.png",
  neonHeartbreak:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986750809_4e57f6ad.jpg",
  outOfOrbit:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986767781_0ba6a8e1.jpg",
  milaRain:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986787354_65419cd8.png",
  noahKade:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986809175_9fd3c540.png",
  dariusCole:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986835747_6ddf50eb.jpg",
  kianaLane:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986874398_28ab4dd4.png",
  healingLotus:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986891701_e9dca9ca.jpg",
  midnightDrive:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986907668_f7d54282.jpg",
  instantDrop:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986932694_df46e3b9.jpg",
  jordan:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986950242_08bd0357.jpg",
  lateNightSoul:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986969747_0621f927.jpg",
  flowers:
    "https://d64gsuwffb70l.cloudfront.net/6a18701749efbfb7c3f35d89_1779986988018_572a0201.jpg",
};
...
export const ROLE_MODES: Record<
  UserRole,
  { label: string; description: string; permissions: StudioPermission[] }
> = {
  fan: {
    label: "Listener Mode",
...
export const TRACKS: Record<string, Track> = {
  ...
  untitledSignal: {
    ...
    artist: "Unknown Broadcast",
    art: "",
    station: "Deep Space Feed",
    src: SH(1),
  },
  brokenSignal: {
    id: "broken-signal",
    title: "Late Night Demo",
    artist: "Producer Bounce",
    art: "https://invalid-image-domain.com/broken.jpg",
    station: "Sonic Identity",
    src: SH(2),
  },
  processingSignal: {
    id: "processing-signal",
    title: "New Drop (Processing)",
    artist: "Trey Trizzy",
    art: "processing",
    station: "TRADIO SIGNAL",
    src: SH(3),
  },
};
      ...
      messages: [
        {
          ...
          author: "Alex M",
          avatar: IMG.jordan,
          message: "🔥🔥 This track is absolute fire right now",
          timestamp: "2m ago",
          verified: false,
        },
        {
          ...
          author: "Trey Trizzy",
          avatar: IMG.treyTrizzy,
          message: "Thanks everyone for the love! New release coming Friday 🎵",
          timestamp: "5m ago",
          verified: true,
        },
        {
          ...
          author: "Cosmic Vibes",
          avatar: IMG.milaRain,
          message: "Finally got my friends into Tradio because of this station",
          timestamp: "8m ago",
          verified: false,
        },
        {
          ...
          author: "Echo Pulse",
          avatar: IMG.flowers,
          message: "The production quality on this is unreal",
          timestamp: "12m ago",
          verified: false,
        },
      ],
      ...
      messages: [
        {
          ...
          author: "Kiana Lane",
          avatar: IMG.kianaLane,
          message: "Love seeing this community grow! 💜",
          timestamp: "1m ago",
          verified: true,
        },
        {
          ...
          message: "This is pure artistry. Kiana deserves so much more",
          timestamp: "4m ago",
          verified: false,
        },
        {
          ...
          author: "Vibe Check",
          avatar: IMG.flowers,
          message: "Every song hits different",
          timestamp: "7m ago",
          verified: false,
        },
      ],
...
export const RELEASES: Release[] = [
  ...
  },
  {
    ...
    title: "Instant Drop",
    artist: "Zaylen",
    artwork: IMG.instantDrop,
    releasedAt: "2 minutes ago",
    streams: 4200,
  },
  {
    id: "rel-2",
  ...
  },
  {
    ...
    title: "Out Of Orbit",
    artist: "Miles Avalon",
    artwork: IMG.outOfOrbit,
    releasedAt: "11 minutes ago",
    streams: 28900,
  },
  {
    id: "rel-4",
...
export const VOICE_DROPS: VoiceDrop[] = [
  {
    ...
    artist: "Trey Trizzy",
    avatar: IMG.treyTrizzy,
    text: "Yo, thanks for rocking with my station! New album coming soon.",
    duration: 4.2,
  ...
  },
  {
    ...
    artist: "Kiana Lane",
    avatar: IMG.kianaLane,
    text: "Hey beautiful souls, thanks for the support. Check out my new release.",
    duration: 5.1,
  ...
  },
  {
    ...
    artist: "JAYE.",
    avatar: IMG.noahKade,
    text: "Appreciate all the love. Stay chill and keep it moving.",
    duration: 3.8,
...
export const SCHEDULE: ScheduleItem[] = [
  {
    id: "sch-songwars",
    title: "PVP Song War: Trey Trizzy vs Kiana Lane",
    artist: "Trey Trizzy & Kiana Lane",
    type: "live",
    startTime: "10:00 PM",
    endTime: "11:00 PM",
    image: IMG.treyTrizzy,
    description: "Live pvp music duel! Round-by-round voting and interactive emoji clashing.",
    status: "live",
    station: "Song Wars Arena",
    listeners: 14850,
  },
  {
    id: "sch-1",
    title: "Midnight Velvet Premiere",
    artist: "Trey Trizzy",
    type: "premiere",
    startTime: "10:00 PM",
    endTime: "10:45 PM",
    image: IMG.treyTrizzy,
    description: "First listen of the new single with fan shoutouts.",
    status: "live",
    station: "Trey Trizzy Radio",
    listeners: 18400,
  },
  {
    id: "sch-2",
    title: "Midnight Therapy Live",
    artist: "Midnight Spin",
    type: "dj-show",
    startTime: "11:00 PM",
    endTime: "1:00 AM",
    image: IMG.midnightVelvet,
    description: "Live DJ show with requests, transitions, and talk breaks.",
    status: "upcoming",
    station: "Late Night R&B",
    listeners: 12600,
  },
  {
    id: "sch-3",
    title: "Alex Beats Spotlight",
    artist: "Alex Beats",
    type: "producer-spotlight",
    startTime: "1:00 AM",
    endTime: "1:30 AM",
    image: IMG.midnightDrive,
    description: "Producer beat showcase ready for artists and DJs.",
    status: "upcoming",
    station: "Producer Signal",
    listeners: 7400,
  },
  {
    id: "sch-4",
    ...
    endTime: "3:00 AM",
    image: IMG.lateNightSoul,
    description: "Listeners vote and request what plays next.",
    status: "upcoming",
    station: "AI Radio",
    listeners: 9100,
  },
  {
    id: "sch-5",
    title: "Replay: Kiana Lane Premiere Room",
    artist: "Kiana Lane",
    type: "replay",
    startTime: "3:00 AM",
    endTime: "4:00 AM",
    image: IMG.kianaLane,
    description: "Replay package with premiere chat highlights.",
    status: "replay",
  ...
  {
    id: "sch-6",
    title: "Trey TV Music Minute",
    type: "sponsored",
    startTime: "4:00 AM",
    endTime: "4:05 AM",
    image: IMG.aiSphere,
    description: "Sponsored/commercial block placeholder.",
    status: "upcoming",
    station: "Network Guide",
    listeners: 0,
  },
];
...
export const COLLECTIONS = [
  ...
  },
  {
    ...
    img: IMG.midnightVelvet,
    tracks: [TRACKS.midnightVelvet, TRACKS.afterHours, TRACKS.fallingForYou],
  },
  {
    title: "Heartbreak Hotel",
    sub: "24 tracks • Updated 5d ago",
    img: IMG.neonHeartbreak,
    tracks: [TRACKS.neonHeartbreak, TRACKS.dontCall, TRACKS.spinning],
  },
  {
    title: "Morning Elevation",
    sub: "18 tracks • Updated 1w ago",
    img: IMG.flowers,
    tracks: [TRACKS.cityLights, TRACKS.underCityLights, TRACKS.outOfOrbit],
  },
];
...
export const ARTIST_MATCH_SUGGESTIONS = [
  {
    ...
    avatar: IMG.milaRain,
    match: 92,
    reason: "Needs warm lo-fi drums for an upcoming acoustic-pop drop.",
  },
  {
    id: "match-2",
    artistId: "artist-kiana",
    artist: "Kiana Lane",
    avatar: IMG.kianaLane,
    match: 87,
    reason: "Building a soul collection with late-night keys and low tempo pockets.",
  },
  {
    id: "match-3",
    artistId: "artist-jaye",
    artist: "JAYE.",
    avatar: IMG.noahKade,
    match: 84,
    reason: "Looking for chill hip-hop loops for a fan playlist premiere.",
  },
];
...
export const DJ_OPPORTUNITIES = [
  {
    id: "opp-1",
    dj: "Midnight Spin",
    show: "Midnight Therapy",
    station: "Trey Trizzy Radio",
    need: "Lo-fi beat spotlight",
    audience: 18400,
  },
  {
    id: "opp-2",
...
export const AD_SLOTS: AdSlot[] = [
  {
    id: "ad-1",
    showId: "show-1",
    title: "Mid-roll sponsor break",
    duration: 90,
    sponsor: "Trey TV Marketplace",
    placement: "mid-roll",
    status: "placeholder",
  },
  {
...
export const HOST_NOTES: HostNote[] = [
  {
    ...
    segmentId: "seg-1",
    title: "Opening tone",
    note: "Welcome listeners like they just stepped into a private after-hours session.",
    tone: "warm, cinematic",
  },
  {
    id: "note-2",
    ...
    note: "Explain why the drum texture matters before the beat preview starts.",
...
export const REPLAY_ITEMS: ReplayItem[] = [
  {
    id: "replay-1",
    showId: "show-1",
    title: "Midnight Therapy Replay",
    host: "Midnight Spin",
    artwork: IMG.midnightVelvet,
    duration: 7200,
    playedAt: "Yesterday, 11 PM",
    plays: 18400,
    saves: 2300,
  },
  {
    id: "replay-2",
    showId: "show-2",
    title: "Kiana Lane Premiere Room",
    host: "Kiana Lane",
    artwork: IMG.kianaLane,
    duration: 3600,
    playedAt: "May 27, 9 PM",
    plays: 12600,
    saves: 1800,
  },
];
