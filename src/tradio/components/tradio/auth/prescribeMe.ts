...
type PrescribeMeTasteProfileKey = Extract<
  MockIdentityKey,
  "fan" | "artist" | "producer" | "dj" | "multi" | "admin"
>;

export const MOCK_TRADIO_TASTE_PROFILES: Record<
  PrescribeMeTasteProfileKey,
  TradioMusicTasteProfile
> = {
  fan: {
    ...bridge("fan"),
  ...
  producer: {
    ...
    dj_opportunity_preferences: [
      "producer spotlight blocks",
      "request-hour beat beds",
      "battle intro loops",
    ],
  },
  dj: {
  ...
  admin: {
    ...
    station_habits: [
      "monitors trending stations",
      "reviews broadcast readiness",
      "features creator momentum",
    ],
    community_participation:
      "Looks for moderation attention areas and featured content candidates.",
  },
};
