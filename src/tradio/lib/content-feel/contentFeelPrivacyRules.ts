...
export type SafeExplanationKey = Exclude<
  keyof typeof SAFE_EXPLANATION_TEMPLATES,
  "selected_energy"
>;
 ...
 */
export const safeRecommendationReason = (
  proposed?: string,
  fallback: SafeExplanationKey = "selected_answer",
): string => {
