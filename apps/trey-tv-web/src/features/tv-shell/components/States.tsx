  ...
  <section className="mb-8">
    ...
    <div className="flex gap-4">
      {Array.from({ length: 5 }).map((_, i) => (
        <div
          key={i}
          className="w-[280px] h-[160px] rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 overflow-hidden relative"
        >
...
export const ErrorState: React.FC<{ onRetry?: () => void; title?: string; message?: string }> = ({
  ...
  <GlassPanel className="p-10 text-center max-w-xl mx-auto">
    ...
    <FocusButton variant="primary" onClick={onRetry} autoFocus>
      Retry
    </FocusButton>
  </GlassPanel>
);
...
export const RestrictedState: React.FC = () => (
  <GlassPanel className="p-10 text-center max-w-xl mx-auto">
    ...
    <div className="text-sm text-white/60 mt-1 mb-4">
      This area requires an active Trey TV account.
    </div>
