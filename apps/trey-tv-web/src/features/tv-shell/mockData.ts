...
export type VideoTile = {
  ...
  badge?: string; progress?: number; meta?: string; description?: string;
  backdropUrl?: string; posterUrl?: string; thumbnailUrl?: string;
};
...
export const interactiveStories: VideoTile[] = [
  { id: 's1', title: 'Story Journey', meta: 'Your Choices, Your Legacy', badge: 'NEW', image: IMG(2) },
...
export const guideChannels: GuideChannel[] = [
  ...
  { id: 'ch106', num: '106', name: 'AFTER DARK', programs: [
  ...
  { id: 'ch107', num: '107', name: 'DOCU ZONE', programs: [
    { title: 'Built Different', time: '8:00 - 9:00 PM' },
    { title: 'The Come Up', time: '9:00 - 10:00 PM' },
    { title: 'From The Mud', time: '10:00 - 11:00 PM' },
  ]},
];
export const guideTimes = ['8:00 PM','8:30 PM','9:00 PM','9:30 PM','10:00 PM','10:30 PM','11:00 PM'];
...
export const quickActions = [
  'Upload Video','Go Live','Manage Content','Analytics','Messages','Monetization','Settings'
];

export const decisions = [
  { id: 1, title: 'SEAL THE DEAL', desc: 'Lock it in now and secure the bag.', risk: 'MEDIUM', tone: 'magenta' },
  { id: 2, title: 'CONSULT THE CREW', desc: "Get your team's input before making a move.", risk: 'LOW', tone: 'green' },
  { id: 3, title: 'PLAY BOTH SIDES', desc: 'Keep your options open and gather more intel.', risk: 'HIGH', tone: 'red' },
  { id: 4, title: 'WALK AWAY', desc: "This isn't worth the risk. Live to fight another day.", risk: 'EXTREME', tone: 'purple' },
];
