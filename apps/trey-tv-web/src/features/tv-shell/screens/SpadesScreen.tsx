    ...
    <div className="relative min-h-screen w-full bg-[#05050A] text-white overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-8 py-5">
        <div className="flex items-center gap-6">
          ...
          <button
            onClick={back}
            className="px-3 py-2 rounded-xl bg-white/5 border border-white/10 outline-none focus:border-fuchsia-400"
          >
          ...
          <div className="flex items-center gap-3 px-4 py-2 rounded-2xl border border-fuchsia-500/30 bg-gradient-to-br from-fuchsia-900/30 to-purple-900/30">
            ...
            <div>
              ...
              <div className="text-[10px] tracking-[0.3em] font-bold text-fuchsia-300">
                LIVE · MATCH
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-sm text-white/70">
            Room: <span className="text-white font-bold">Trey's Table 🔒</span>
          </div>
          <div className="text-sm text-white/70">
            Stake: <span className="text-amber-300 font-bold">250</span>
          </div>
          ...
          <div className="flex items-center gap-2 px-3 py-2 rounded-2xl border border-white/10 bg-white/5">
            ...
            <div>
              <div className="flex items-center gap-1 text-sm font-bold">
                {profile.name} <Crown className="w-3.5 h-3.5 text-amber-300" />
              </div>
              <div className="text-[9px] font-black bg-gradient-to-r from-fuchsia-600 to-purple-700 px-1.5 rounded inline-block">
                PREMIUM
              </div>
            </div>
      ...
      <div className="relative z-10 grid grid-cols-[200px_1fr_320px] gap-5 px-8 pb-6">
        ...
        <div className="space-y-4">
          <GlassPanel className="p-5 text-center">
            ...
            <div className="text-5xl font-black bg-gradient-to-b from-fuchsia-300 to-purple-500 bg-clip-text text-transparent">
              500
            </div>
            <div className="mt-3 flex justify-between text-xs">
              <span className="text-white/60">BAGS</span>
          ...
          <GlassPanel className="p-5 text-center">
            <div className="text-[10px] tracking-widest text-fuchsia-300 font-bold">
              TREY TV EXCLUSIVE
            </div>
            <div className="mt-2 text-3xl font-black bg-gradient-to-r from-fuchsia-400 to-purple-500 bg-clip-text text-transparent italic">
              2X SPADES
            </div>
        ...
        <div className="relative flex flex-col items-center">
            ...
            {hand.map((c, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={
                      "flex flex-col items-center text-sm font-black " +
                      (c.red ? "text-red-600" : "text-black")
                    }
                  >
                    <span>{c.rank}</span>
                  ...
                  {isSel && (
                    <span className="absolute -top-3 left-1/2 -translate-x-1/2 text-fuchsia-400 text-xl">
                      ▼
                    </span>
                  )}
                </button>
          ...
          <div className="mt-6 grid grid-cols-4 gap-3 w-full max-w-[640px]">
            <FocusButton variant="primary" autoFocus>
              PLAY CARD
            </FocusButton>
        ...
        <div className="space-y-4">
          <GlassPanel className="p-4">
            <div className="flex border-b border-white/10 mb-3">
              <div className="px-3 py-2 text-xs font-bold border-b-2 border-fuchsia-400 text-fuchsia-300">
                LIVE CHAT
              </div>
            ...
            <div className="mt-3 flex items-center gap-2 rounded-xl bg-white/5 border border-white/10 px-3 py-2">
              ...
              />
              <button className="px-3 py-1 rounded-md bg-fuchsia-600 text-xs font-bold flex items-center gap-1">
          ...
          <GlassPanel className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1 text-xs">
                <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse" /> 12.4K
              </div>
            </div>
            <div className="flex -space-x-2">
              {[0, 1, 2, 3, 4].map((i) => (
                <img
                  key={i}
                  src={IMG(i)}
                  className="w-9 h-9 rounded-full border-2 border-[#05050A] object-cover"
                />
              ))}
              <div className="w-9 h-9 rounded-full bg-fuchsia-600 border-2 border-[#05050A] flex items-center justify-center text-[10px] font-black">
                +12K
              </div>
            </div>
          </GlassPanel>
          ...
          <GlassPanel className="p-4 relative overflow-hidden">
            ...
            <div className="text-3xl font-black italic bg-gradient-to-r from-fuchsia-400 to-purple-500 bg-clip-text text-transparent">
              SPADES
            </div>
            <div className="text-xs font-bold tracking-widest text-white/70">TOURNAMENT</div>
            <div className="mt-3 text-amber-300 font-black text-2xl">
              $10,000 <span className="text-xs text-white/60">PRIZE POOL</span>
            </div>
...
const PlayerSeat: React.FC<{
  ...
  return (
    <div className={`absolute ${posCls} flex items-center gap-1`}>
      <img
        src={img}
        className="w-14 h-14 rounded-full border-2 border-fuchsia-400/60 object-cover"
      />
      <div className="text-center">
        <div className="text-xs font-bold flex items-center gap-1 justify-center">
          {name} {you && <span className="px-1.5 rounded bg-fuchsia-600 text-[9px]">You</span>}
        </div>
