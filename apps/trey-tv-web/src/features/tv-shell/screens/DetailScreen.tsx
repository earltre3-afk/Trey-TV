      ...
      <section className="relative -mx-8 -mt-2 h-[620px] overflow-hidden">
        ...
        <div className="relative px-12 pt-8 max-w-3xl">
          ...
          <h1 className="text-7xl font-black mt-2 leading-none">
            ...
            <span className="block bg-gradient-to-r from-fuchsia-400 to-purple-500 bg-clip-text text-transparent italic">
              CREATOR
            </span>
          </h1>
          <div className="mt-3 text-lg tracking-[0.2em] font-bold text-white/80">
            REAL PASSION. REAL PROCESS. REAL IMPACT.
          </div>

          <div className="mt-6 flex items-center gap-3 text-sm text-white/80 flex-wrap">
            <span>2024</span>
            <span className="px-2 py-0.5 rounded-md bg-white/10 border border-white/20 font-bold">
              TV-MA
            </span>
          ...
          <p className="mt-5 text-base text-white/80 max-w-xl leading-relaxed">
            Go behind the scenes with Trey Trizzy as he builds his brand, creates his music, and
            inspires a generation. This is more than content — it's a lifestyle.
          </p>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3 max-w-md">
            ...
            <FocusButton variant="ghost" icon={<RotateCcw className="w-5 h-5" />}>
              Play From Start
            </FocusButton>
            <FocusButton variant="ghost" icon={<Film className="w-5 h-5" />}>
              Watch Trailer
            </FocusButton>
