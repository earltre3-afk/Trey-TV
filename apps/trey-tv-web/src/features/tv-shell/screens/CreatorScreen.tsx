  ...
  return (
    <TVFrame activeRail="Browse">
      ...
      <section className="relative h-[440px] rounded-3xl overflow-hidden border border-fuchsia-500/30 mb-6 shadow-[0_0_60px_rgba(168,85,247,0.2)]">
        ...
        <span className="absolute top-5 right-5 px-3 py-1.5 rounded-md bg-amber-400 text-black text-xs font-black">
          4K ULTRA HD
        </span>
        ...
        <div className="relative grid grid-cols-2 h-full">
          <div className="flex flex-col justify-center px-10">
            ...
            <p className="text-lg text-white/85 mt-1 font-semibold">
              Artist. Creator. Entrepreneur. Built Different.
            </p>
            <p className="text-sm text-white/65 mt-2 max-w-md">
              Welcome to the official channel of Trey Trizzy – exclusive content, music videos,
              behind-the-scenes, live streams, and more.
            </p>

            <div className="mt-5 flex items-center gap-3">
              <FocusButton variant="primary" icon={<Plus className="w-5 h-5" />} autoFocus>
                Follow
              </FocusButton>
              <FocusButton variant="gold" icon={<Crown className="w-5 h-5" />}>
                Subscribe
              </FocusButton>
            ...
            <div className="mt-6 grid grid-cols-4 gap-6 max-w-lg">
              {[
                ...
                <div key={s.l}>
                  <div className="text-2xl font-black bg-gradient-to-r from-fuchsia-400 to-purple-500 bg-clip-text text-transparent">
                    {s.n}
                  </div>
          ...
          <div className="relative">
            <div className="absolute bottom-4 right-6 flex items-center gap-3">
              {[Instagram, Music, Twitter, Globe].map((Icon, i) => (
                <button
                  key={i}
                  className="w-10 h-10 rounded-full bg-white/10 border border-white/15 flex items-center justify-center outline-none focus:border-fuchsia-400 focus:shadow-[0_0_18px_rgba(255,43,214,0.6)]"
                >
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            <button
              key={p.t}
              className="group relative h-32 rounded-2xl overflow-hidden border border-white/10 bg-white/5 outline-none focus:border-fuchsia-400 focus:shadow-[0_0_28px_rgba(255,43,214,0.55)] focus:scale-[1.04] transition-all"
            >
              <img
                src={IMG(i + 2)}
