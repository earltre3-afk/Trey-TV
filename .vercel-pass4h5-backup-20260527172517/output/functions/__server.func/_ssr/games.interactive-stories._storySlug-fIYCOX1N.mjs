...
function StorySlugPage() {
  const {
    ...
    from: "/games/interactive-stories/$storySlug"
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-sans antialiased", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-base font-black", children: "Loading Story" })
  ] }) }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(InteractiveStoriesPlayer, { storySlug, initialView: "main", onBack: () => window.history.back() }) }) });
}
export {
  StorySlugPage as component
};
