...
function OAuthUserInfoEndpoint() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen bg-background grid place-items-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl rounded-3xl liquid-glass neon-border p-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 text-3xl font-black", children: "/oauth/userinfo" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground leading-6", children: "This endpoint is reserved for scoped Trey TV identity responses. It should require a valid bearer token and return only data covered by approved scopes." }),
...
export {
  OAuthUserInfoEndpoint as component
};
