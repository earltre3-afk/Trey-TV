...
-- Updated_at Triggers
DROP TRIGGER IF EXISTS tradio_set_updated_at_live_recordings ON tradio_live_recordings;
CREATE TRIGGER tradio_set_updated_at_live_recordings
  BEFORE UPDATE ON tradio_live_recordings
  FOR EACH ROW EXECUTE FUNCTION tradio_set_updated_at();

DROP TRIGGER IF EXISTS tradio_set_updated_at_live_recording_segments ON tradio_live_recording_segments;
CREATE TRIGGER tradio_set_updated_at_live_recording_segments
  BEFORE UPDATE ON tradio_live_recording_segments
  FOR EACH ROW EXECUTE FUNCTION tradio_set_updated_at();

DROP TRIGGER IF EXISTS tradio_set_updated_at_live_highlight_clips ON tradio_live_highlight_clips;
CREATE TRIGGER tradio_set_updated_at_live_highlight_clips
  BEFORE UPDATE ON tradio_live_highlight_clips
  FOR EACH ROW EXECUTE FUNCTION tradio_set_updated_at();

DROP TRIGGER IF EXISTS tradio_set_updated_at_live_archive_jobs ON tradio_live_archive_jobs;
CREATE TRIGGER tradio_set_updated_at_live_archive_jobs
  BEFORE UPDATE ON tradio_live_archive_jobs
  FOR EACH ROW EXECUTE FUNCTION tradio_set_updated_at();

DROP TRIGGER IF EXISTS tradio_set_updated_at_live_recording_consents ON tradio_live_recording_consents;
CREATE TRIGGER tradio_set_updated_at_live_recording_consents
  BEFORE UPDATE ON tradio_live_recording_consents
  FOR EACH ROW EXECUTE FUNCTION tradio_set_updated_at();
